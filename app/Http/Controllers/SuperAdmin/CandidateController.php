...
class CandidateController extends Controller
{
    ...
    public function candidate(){
        ...
        return view('admin.candidate.candidate',compact('Constituencies','electionTypes'));
    }
    public function candidateRegister($id){
        ...
        return view('admin.candidate.candidate_register',compact('type','NewElectionTypes','country','electionTypes','PoliticalParties'));
    }
    ...
    public function candidateAjax(Request $request){
        ...
        if($request->input('election_id') != "all")
            $candidate = $candidate->where('election_type.id',$request->input('election_id'));
    ...
    public function candidateEdit($id){
       ...
       $candidate = Candidate::find($id);
        ...
        return view('admin.candidate.candidate_edit',compact('pollings','ElectoralAreas','Constituencies','regions','candidate','type','NewElectionTypes','country','electionTypes','PoliticalParties'));
