...
<div class="row">
    <div class="col-md-8 col-sm-8 col-xs-8 col-md-offset-2">
        <div class="x_panel">
          ...
          <div class="x_content ">
                <form id="demo-form2" method="POST" action="{{route('National.candidateRegisterPost')}}" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" >
                        @csrf
                    ...
                    // $("#username_panel").append(`<span class="fa fa-spinner"><span>` )
                        ...
                        @if($NewElectionTypes[0] && !isset($NewElectionTypes[1]))
                            ...
                            // $("#username_panel").append(`<span class="fa fa-spinner"><span>` )
                                ...
                                $.ajax({
                                        type: "POST",
                                        url: '{{route("National.getPoliticalPartyByElectionType")}}',
                        ...
                        @elseif(isset($NewElectionTypes[1]) && $NewElectionTypes[1] && !isset($NewElectionTypes[2]))
                            ...
                            // $("#username_panel").append(`<span class="fa fa-spinner"><span>` )
                                ...
                                $.ajax({
                                        type: "POST",
                                        url: '{{route("National.getPoliticalParty")}}',
                                        data: {constituency_id:constituency_id,_token:_token},
                                        //dataType: "JSON",
                                        success: function (result) {
                                            $('#party_id')
