...
<head>
 ...
 --}}
    ...
    <!-- CSS Files -->
    <link href="{{ asset('material_kit_assets/css/material-kit.css') }}?v=2.0.4" rel="stylesheet" />
    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link href="{{ asset('material_kit_assets/demo/demo.css') }}" rel="stylesheet" />
    {{-- material kit file end --}}
</head>
<body>
    <div id="app">
