...
<head>
    ...
    <link href="http://127.0.0.1:8000/gentelella/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    @yield("css")
</head>
<body>
...
<div id="wrapper">
						...
						<li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <a href="{{ route('logout') }}"
                                    ...
                                    <li>
						                <li><a href="{{route('National.profile')}}" class="{{ (Request::is('National.profile') ? 'active' : '') }}"><i class="lnr lnr-home"></i> <span>Profile</span></a></li>
        ...
        <div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="{{route('National.dashboard')}}" class="{{ (Request::is('National.dashboard') ? 'active' : '') }}"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
                        <li>
							...
							<div id="apiPages" class="collapse ">
								<ul class="nav">
                                    <li><a href="#">Confirm Results</a></li>
                                    {{-- <li><a href="{{route('National.Presidential')}}">Presidential Results</a></li>
                                    <li><a href="{{route('National.ConstituencyResult')}}">Constituency Results</a></li> --}}

                                    @foreach ($__electionTypes as $electionType)
                                    <li><a href="{{route('National.result',$electionType['id'])}}">{{$electionType['name']}} </a></li>
                                    @endforeach
                                </ul>
							</div>
                        </li>
                        <li><a href="{{route('National.pollingAgent')}}" class="{{ (Request::is('National.pollingAgent') ? 'active' : '') }}"><i class="lnr lnr-user"></i> <span>Polling Agent</span></a></li>
                        <li><a href="{{route('National.candidate')}}" class="{{ (Request::is('National.candidate') ? 'active' : '') }}"><i class="lnr lnr-user"></i> <span>Candidate</span></a></li>
                        <li>
							<a href="#adminSEction" data-toggle="collapse" class="collapsed"> <span>Admin Section</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="adminSEction" class="collapse ">
								<ul class="nav">
                                    <li><a href="{{route('National.ElectoralArea')}}">Electoral Area</a></li>
                                    <li><a href="{{route('National.PollingStation')}}">Polling Station</a></li>
                                </ul>
							</div>
                        </li>
                        <li><a href="{{route('National.Users')}}" class="{{ (Request::is('National.Users') ? 'active' : '') }}"><i class="lnr lnr-user"></i> <span>Managers</span></a></li>
            ...
            <div class="main">
                ...
                <div class="panel-body" style="background-color:#f0f8ff;margin-top:50px">
                                        ...
                                        <div class="col-md-4">
                                                <strong> Total Registered Voters : </strong>{{$user->total_voters}}
                                        </div>
                                        <div class="col-md-12">
                                            <br>
                                        </div>
