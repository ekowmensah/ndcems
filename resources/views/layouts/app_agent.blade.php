...
<div id="custom-bootstrap-menu" class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-image: linear-gradient(black, red, white, green)">
    <div class="container-fluid">
        ...
        <div class="navbar-header"><a class="navbar-brand" href="{{url('/')}}" style="margin:5px;padding:5px;"><img style="width:70px;height:70px;border:15px;border-radius:50%;" border="5" src="/user_logo/{{Auth::user()->photo}}" class="img-responsive" /></a>
