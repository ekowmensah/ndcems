...
<div class="container">
    <div class="row">
        <div class="col-md-6" style=" float:  left;">
            <h3>Create New User Type <small> E.g Polling Agent</small></h3>
        </div>
          ...
          <div class="x_content ">
                <form id="demo-form2" method="POST" action="{{route('SuperAdmin.New.UserTypes')}}" data-parsley-validate="" class="form-horizontal form-label-left" >
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">User Type Name <span class="required">*</span>
                          </label>
