...
<div class="">
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form method="post" id="input-form" data-parsley-validate="" action="{{route('SuperAdmin.electionDetailPost',$election->id)}}" class="form-horizontal form-label-left" novalidate="">
        {{ csrf_field() }}
        @foreach ($countries as $country)
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" name="election_name" @if(isset($election->election_name)) value="{{$election->election_name}}" @endif id="fname"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
        ...
        <div class="form-group" id="site-gateways"></div>
          ...
          <div class="form-group">
            <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-3 pull-right">
              <input type="submit" class="btn btn-success" value="Start Election">
            </div>
          </div>
        </form>
      </div>
