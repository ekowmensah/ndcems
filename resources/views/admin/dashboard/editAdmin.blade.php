...
@section('content')
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        @endif
                    <form method="post" id="input-form" data-parsley-validate="" action="{{route('SuperAdmin.edit.AdminPost',$superAdmin->id)}}" class="form-horizontal form-label-left" novalidate="">
                    {{ csrf_field() }}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="role_name">Full Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="{{$superAdmin->name}}" name="name" value="" id="fname"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" value="{{$superAdmin->email}}" name="email" value="" id="email"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
