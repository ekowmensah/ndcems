...
<div class="container">
    <div class="row">
        <div class="col-md-6" style=" float:  left;">
            <h3> Polling Station<small> </small></h3>
        </div>
        ...
        <div class="x_panel">
          ...
          <div class="x_content ">
            ...
            @endif
                ...
                <form id="demo-form2" method="POST" action="{{route('SuperAdmin.PollingStationEditPost',$polling->id)}}" data-parsley-validate="" class="form-horizontal form-label-left" >
                        @csrf
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input name="name" type="text" value="{{$polling->name}}" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input name="polling_station_id" value="{{$polling->polling_station_id}}" type="text" id="polling_station_id" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input name="total_voters" value="{{$polling->total_voters}}" type="text" id="total_voters" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="country_id" id="country_id" required>
                                           ...
                                           @foreach ($countries as $country)
                                                <option value="{{$country->id}}" @if($polling->country_id == $country->id) selected @endif >{{$country->name}}<option>
                                             @endforeach
                                           </select>
                                </div>
                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="region_id" id="region_id"  required>
                                            @foreach ($region as $country)
                                                <option value="{{$country->id}}" @if($polling->region_id == $country->id) selected @endif >{{$country->name}}<option>
                                             @endforeach
                                           </select>
                                </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="constituency_id" id="constituency_id"  required>
                                        @foreach ($cc as $country)
                                                <option value="{{$country->id}}" @if($polling->constituency_id == $country->id) selected @endif >{{$country->name}}<option>
                                             @endforeach
                                       </select>
                            </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="electoralarea_id" id="electoralarea_id"  required>
                                    @foreach ($ee as $country)
                                    <option value="{{$country->id}}" @if($polling->electoralarea_id == $country->id) selected @endif >{{$country->name}}<option>
                                 @endforeach
                                   </select>
                        </div>
                </div>
