...
<div class="container">
    <div class="row">
        <div class="col-md-6" style=" float:  left;">
            <h3>Add Country<small> E.g Ghana</small></h3>
        </div>
...
<div class="row">
    <div class="col-md-8 col-sm-8 col-xs-8 col-md-offset-2">
        <div class="x_panel">
          ...
          <div class="x_content ">
                <form id="demo-form2" method="POST" action="{{route('SuperAdmin.New.Country')}}" data-parsley-validate="" class="form-horizontal form-label-left" >
                        @csrf
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input name="country_id" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                        </div>
