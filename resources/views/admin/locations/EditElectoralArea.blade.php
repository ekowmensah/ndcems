...
<div class="row">
    <div class="col-md-8 col-sm-8 col-xs-8 col-md-offset-2">
        <div class="x_panel">
          ...
          <div class="x_content ">
                <form id="demo-form2" method="POST" action="{{route('SuperAdmin.ElectoralAreaEditPost',$electoralArea->id)}}" data-parsley-validate="" class="form-horizontal form-label-left" >
                        @csrf
                        <div class="form-group">
                          ...
                          <input name="name" value="{{$electoralArea->name}}" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="country_id" id="country_id" required>
                                           ...
                                           @foreach ($countries as $country)
                                                <option value="{{$country->id}}" @if($electoralArea->country_id  == $country->id) selected @endif  >{{$country->name}}<option>
                                             @endforeach
                                           </select>
                                </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="region_id" id="region_id"  required>
                                            @foreach ($ps as $country)
                                                <option value="{{$country->id}}" @if($electoralArea->region_id == $country->id) selected @endif >{{$country->name}}<option>
                                             @endforeach
                                           </select>
                                </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="constituency_id" id="constituency_id"  required>
                                        @foreach ($cc as $country)
                                            <option value="{{$country->id}}" @if($electoralArea->constituency_id == $country->id) selected @endif >{{$country->name}}<option>
                                        @endforeach
                                       </select>
                            </div>
                    </div>
