        ...
        <div class="x_panel">
          ...
          <div class="x_content ">
            ...
            @endif
                ...
                <form id="demo-form2" method="POST" action="{{route('Director.New.PollingStation')}}" data-parsley-validate="" class="form-horizontal form-label-left" >
                        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="electoralarea_id" id="electoralarea_id"  required>
                                    <option value="sec" >Select Electoral Area<option>
                                        @foreach ($countries as $country)
                                             <option value="{{$country->id}}"  >{{$country->name}}<option>
                                          @endforeach
                                   </select>
