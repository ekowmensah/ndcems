...
<div class="row">
    <div class="col-md-8 col-sm-8 col-xs-8 col-md-offset-2">
        <div class="x_panel">
          ...
          <div class="x_content ">
                <form id="demo-form2" method="POST" action="{{route('Director.ElectoralAreaEditPost',$electoralArea->id)}}" data-parsley-validate="" class="form-horizontal form-label-left" >
                        @csrf
