...
@section('content')
        ...
        <!-- MAIN CONTENT -->
        <form action="{{route('Director.CaptureResult',[$election_start_up,$user_id])}}" method="POST" id="terminal-form" class="form-horizontal form-label-left input_mask">
            @csrf
            <div >
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body" style="border: 6px solid #f1f8ff">
                                                ...
                                                @else
                                                    ...
                                                    <div class="col-md-4" >
                                                            <input  type="text" class="form-control has-feedback-left" tabindex="1" data-required-error="" id="total1111"  name="total1111"  placeholder="Total Vote" disabled>
