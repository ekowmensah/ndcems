...
<div class="row">
    <div class="col-md-8 col-sm-8 col-xs-8 col-md-offset-2">
        <div class="x_panel">
          ...
          <div class="x_content ">
                <form id="demo-form2" method="POST" action="{{route('Director.candidateRegisterPost')}}" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" >
                        @csrf
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input name="first_name" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input name="phone" type="text" id="first-name"  class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control " data-live-search="true" name="election_start_up_id" id="election_start_up_id"  required>
                                        ...
                                        <option value="s" disabled selected>Select Elections<option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control "  name="region_id" id="region_id"  required>
                                                @foreach ($region as $electionType)
                                                    <option value="{{$electionType->id}}"  >{{$electionType->name}}<option>
                                                @endforeach
                                            </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="constituency_id" id="constituency_id"  required>
                                                @foreach ($constituency as $electionType)
                                                <option value="{{$electionType->id}}"  >{{$electionType->name}}<option>
                                            @endforeach
                                            </select>
                                    </div>
                ...
                $("#electoralarea_id").on('change', '', function (e) {
                    ...
                    // $("#username_panel").append(`<span class="fa fa-spinner"><span>` )
                        ...
                        $('#party_id').find('option').remove()
                            ...
                            var constituency_id =  {!! json_encode(Auth::user()->constituency_id) !!};
                                    var _token = $('input[name="_token"]').val();
                                $.ajax({
                                        type: "POST",
                                        url: '{{route("Director.getPoliticalParty")}}',
                                        data: {constituency_id:constituency_id,_token:_token},
                                        //dataType: "JSON",
                                        success: function (result) {
                                           $.each(result, function(key, value) {
